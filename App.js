...
// ⚡ Remplace localhost par ton IP si tu testes sur smartphone
    ...
    <Swiper loop={false} showsPagination={false}>
      {duels.map((duel) => (
        <View key={duel._id} style={{ flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "#111" }}>
          ...
          {/* Pub simulée */}
          <View style={{ marginTop: 20, padding: 10, backgroundColor: "#222", width: "90%", alignItems: "center" }}>
            <Text style={{ color: "yellow" }}>Publicité</Text>
          </View>
        </View>
      ))}
    </Swiper>
